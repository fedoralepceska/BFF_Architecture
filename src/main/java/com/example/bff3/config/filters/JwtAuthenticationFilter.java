package com.example.bff3.config.filters;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.example.bff3.exceptions.PasswordsDoNotMatchException;
import com.example.bff3.model.User;
import com.example.bff3.model.UserDТО;
...
//            throw new UserNotFoundException("Invalid credentials");
    ...
    public String generateJwt(HttpServletResponse response, Authentication authResult) throws JsonProcessingException {
        ...
        String token = JWT.create()
                .withSubject(new ObjectMapper().writeValueAsString(UserDТО.of(userDetails)))
